...
while(rs.next())
	...
	<tr><td>    <tr><td>
<font size="3" color="#66ff00"><%=rs.getString(1)%></font><br>
...
<br>
<form method="post" action="fuzzy4.jsp">
 <div class="form_settings"><input class="submit" type="submit"  value="Caluculate" /></div>
</form>
